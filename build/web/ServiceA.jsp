...
<section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Tableau Service</h3>
          	<div class="row mt">
          		<div class="col-lg-12">                    
          		<a href="InsertService.jsp"> <button  style="float:right; font-size: 120%;">Ajouter</button></a>
		 ...
		 <table id="opportunite" cellpadding="10">
                   ...
                   PreparedStatement ps= conn.prepareStatement("select *  from service ORDER BY service_id");
                           ...
                           <tr>
                              <td><%=rs.getString("id_merge")%></td>
                               ...
                               <td><%=rs.getString("createur")%></td>
                                <%int i=rs.getInt("service_id");  %>
                               
                               
                                <td id="link"><div  ><a   href="UpdateService.jsp?id=<%=rs.getString("service_id")   %>" ><img  src="<c:url value='/include/edit2.png'/>" style=" height: 30px;width: 30px; "  ></a></div></td>
                              
                              <td><a href="Delete_Service?id=<%=rs.getString("service_id")%>&chance=<%=rs.getString("chance")%>" ><img src="<c:url value='/include/edit3.png'/>" style=" height: 30px;width: 30px;"></a></td>
                                   <script>
    ...
    if (td) {
      if (td.innerHTML.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
                           ...
                           <form action="Importer_Service" method="post" enctype="multipart/form-data">
