...
<section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>   Service/ajouter</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
                            <p></p>
                        </div>
                ...
                <div class="reda">
                    <h2></h2>
          		<form action="Insertion_Service" method="post" id="formulaire" class="form-horizontal"> 
                            <table class="table_sign_up">
                                <tr><td> <label for="id_merge">Code Rh</label></td>
                                    <td> <input type="text" name="id_merge"></td>
                            
                                    <td><label for="chance">Service</label></td>
