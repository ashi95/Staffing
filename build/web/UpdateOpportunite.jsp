...
<section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>  Opportunite/Modifier</h3>
          	<div class="row mt">
                </div>
                  ...
                  Connection  conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/staffing", "root", "root");
                               ...
                               <div class="reda">
                                   <h2></h2>
                               <form action="SaveOpportunite" method="post" id="formulaire" class="form-horizontal">
                            <%
                            
                           Statement stat=conn.createStatement();
                           
                            String data="select * from chance where opportunite_id="+id;
                            ResultSet rs=stat.executeQuery(data);
                            while(rs.next()){
                            %>
                             <input type="hidden" name="id" value="<%=rs.getString("opportunite_id") %>">
